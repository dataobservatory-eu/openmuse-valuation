...
| `quantity` |  |
| `blanket license` |  |
| `quantity estimation` | The amount or volume of a good or service sold, produced, or consumed. In economics, it's often paired with price to calculate total revenue. |
...
| `tariff table` | A published schedule that lists standard licensing fees or royalty rates for different types of music use (e.g., radio, streaming, live events), often set by CMOs or regulatory bodies. |
...
Our glossary is harmonised with relevant music-sector specific standards and with the ISO *Information technology — Vocabulary* [@iso_2382_2015]; *Information technology — Cloud computing — Taxonomy based data handling for cloud services* [@iso_22624_2020] and *Information technology — Cloud computing — Interoperability and portability* [@iso_19941_2017]. {{< pagebreak >}}
